...
ProphecyDescription:
	text "Bekijk tot 3 kaarten van de boven-"
	line "kant van het deck van elke speler"
	line "en leg ze terug in de volgorde die"
	line "je wilt."
	done

HypnoDescription:
	text "Als hij de ogen kruist met een"
	line "vijand, gebruikt hij een mengsel"
	line "van psychische tactieken zoals"
	line "Hypnose en Verwarring."
	done
...
InvisibleWallDescriptionCont:
	text "Deze kracht kan niet worden gebruikt"
	line "als Mr. Mime In Slaap, Verward, of"
	line "Verlamd is."
	done
