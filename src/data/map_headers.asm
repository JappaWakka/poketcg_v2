...
; sgb tilemap, cgb tilemap, initial cgb palette (always 0), sgb palette, final cgb palette, song
	...
	db TILEMAP_CLUB_LOBBY,              TILEMAP_CLUB_LOBBY_CGB,              PALETTE_0, MAP_SGB_PALS_3,  PALETTE_168, MUSIC_OVERWORLD     ; FIGHTING_CLUB_LOBBY
	...
	db TILEMAP_CLUB_LOBBY,              TILEMAP_CLUB_LOBBY_CGB,              PALETTE_0, MAP_SGB_PALS_3,  PALETTE_167, MUSIC_OVERWORLD     ; ROCK_CLUB_LOBBY
	...
	db TILEMAP_CLUB_LOBBY,              TILEMAP_CLUB_LOBBY_CGB,              PALETTE_0, MAP_SGB_PALS_3,  PALETTE_163, MUSIC_OVERWORLD     ; WATER_CLUB_LOBBY
	...
	db TILEMAP_CLUB_LOBBY,              TILEMAP_CLUB_LOBBY_CGB,              PALETTE_0, MAP_SGB_PALS_3,  PALETTE_169, MUSIC_OVERWORLD     ; LIGHTNING_CLUB_LOBBY
	...
	db TILEMAP_CLUB_LOBBY,              TILEMAP_CLUB_LOBBY_CGB,              PALETTE_0, MAP_SGB_PALS_3,  PALETTE_165, MUSIC_OVERWORLD     ; PSYCHIC_CLUB_LOBBY
	...
	db TILEMAP_CLUB_LOBBY,              TILEMAP_CLUB_LOBBY_CGB,              PALETTE_0, MAP_SGB_PALS_3,  PALETTE_164, MUSIC_OVERWORLD     ; SCIENCE_CLUB_LOBBY
	...
	db TILEMAP_CLUB_LOBBY,              TILEMAP_CLUB_LOBBY_CGB,              PALETTE_0, MAP_SGB_PALS_3,  PALETTE_166, MUSIC_OVERWORLD     ; FIRE_CLUB_LOBBY
	db TILEMAP_FIRE_CLUB,               TILEMAP_FIRE_CLUB_CGB,               PALETTE_0, MAP_SGB_PALS_8,  PALETTE_20,  MUSIC_CLUB_3        ; FIRE_CLUB
	db TILEMAP_CHALLENGE_HALL_ENTRANCE, TILEMAP_CHALLENGE_HALL_ENTRANCE_CGB, PALETTE_0, MAP_SGB_PALS_3,  PALETTE_11,   MUSIC_OVERWORLD    ; CHALLENGE_HALL_ENTRANCE
	db TILEMAP_CLUB_LOBBY,              TILEMAP_CLUB_LOBBY_CGB,              PALETTE_0, MAP_SGB_PALS_3,  PALETTE_166,  MUSIC_OVERWORLD    ; CHALLENGE_HALL_LOBBY
