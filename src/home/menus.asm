...
; starting tile number, cgb palette (grey, yellow/red, green/blue, pink/orange)
	db ICON_TILE_FIRE,            $02 ; TYPE_ENERGY_FIRE
	db ICON_TILE_GRASS,           $03 ; TYPE_ENERGY_GRASS
	db ICON_TILE_LIGHTNING,       $02 ; TYPE_ENERGY_LIGHTNING
	db ICON_TILE_WATER,           $03 ; TYPE_ENERGY_WATER
	db ICON_TILE_FIGHTING,        $04 ; TYPE_ENERGY_PSYCHIC
	db ICON_TILE_PSYCHIC,         $04 ; TYPE_ENERGY_FIGHTING
	db ICON_TILE_COLORLESS,       $00 ; TYPE_ENERGY_DOUBLE_COLORLESS
	db ICON_TILE_ENERGY,          $03 ; TYPE_ENERGY_UNUSED
	db ICON_TILE_BASIC_POKEMON,   $03 ; TYPE_PKMN_*, Basic
	db ICON_TILE_STAGE_1_POKEMON, $03 ; TYPE_PKMN_*, Stage 1
	db ICON_TILE_STAGE_2_POKEMON, $02 ; TYPE_PKMN_*, Stage 2
	db ICON_TILE_TRAINER,         $03 ; TYPE_TRAINER
	db $00
