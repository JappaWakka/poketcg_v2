...
To install the requisite software:
...
If you have different projects that require different versions of `rgbds`, it might not be convenient to install rgbds 0.9.2 globally. Instead, you can put its files in a directory within poketcg_v2, such as `poketcg_v2/rgbds-0.9.2/`. Then specify it when you run `make`:
